 ...
 * @author Kevin Balke
 *
 * @brief Startup code for the TM4C123GH6PM microcontroller.
 *
 * Bracketed references refer to the appropriate page of the TM4C123GH6PM
...
{
    (void (*)(void))((uint32_t)kernel_stack + sizeof(kernel_stack)),
